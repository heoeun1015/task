...
class Horse extends Thread implements Comparable<Horse> {
	...
	public void run() {
		...
		this.horseRank = HorseRacing.rank;
		HorseRacing.rank++;
	}
}
...
class HorsePositionDisplay extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			System.out.println("==========================================================");
			System.out.println();
			for (int i = 0; i < HorseRacing.hList.size(); i++) {
				if (HorseRacing.hList.get(i).getHorsePosi() != 49) {
					System.out.print(HorseRacing.hList.get(i).getHorseName() + " : ");
					System.out.print(horseCourse.substring(0, HorseRacing.hList.get(i).getHorsePosi()) + ">");
					System.out.println(horseCourse.substring(HorseRacing.hList.get(i).getHorsePosi(), 49));
				} else {
					System.out.print(HorseRacing.hList.get(i).getHorseName() + " : ");
					System.out.print(horseCourse.substring(0, HorseRacing.hList.get(i).getHorsePosi()) + "도착");
					System.out.println();
					finishedCnt++;
				}
			}
